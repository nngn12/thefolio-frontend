        ...
        <div style={{ fontFamily: t.fontSans, background: t.bg, minHeight: "100vh", paddingBottom: "80px" }}>
            ...
            <div style={{
                ...
                <h1 style={{
                    ...
                    color: t.text, letterSpacing: "-0.02em", marginBottom: "16px", lineHeight: 1.15
                }}>Latest Memories</h1>
                ...
                {user && (
                    <button onClick={() => navigate("/create")} style={{
                        padding: "11px 28px", borderRadius: "24px", border: "none",
                        background: t.pinkGrad, color: "white", fontFamily: t.fontSans,
                        fontWeight: "600", fontSize: "13px", letterSpacing: "0.06em",
                        cursor: "pointer", boxShadow: "0 4px 18px rgba(190,24,93,0.3)",
            ...
            <div style={{ maxWidth: "760px", margin: "0 auto", padding: "48px 24px 0" }}>
                ...
                <div style={{ display: "grid", gap: "2px" }}>
                    {posts.map((post, i) => {
                        ...
                        return (
                            <article key={post.id} onClick={() => navigate(`/post/${post.id}`)}
                                style={{
                                ...
                                <div style={{ flex: 1, paddingRight: coverImage ? "24px" : "0" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                                        <div style={{
                                            ...
                                            background: t.pinkGrad, display: "flex", alignItems: "center",
                                            justifyContent: "center", color: "white", fontSize: "10px", fontWeight: "700",
                                            overflow: "hidden",
                                        }}>
                                            {authorPic
                                                ? <img src={`http://localhost:5000/uploads/${authorPic}`} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                    ...
                                    <span style={{ display: "inline-block", marginTop: "14px", fontSize: "12px", color: t.pink, fontWeight: "500", letterSpacing: "0.06em", textTransform: "uppercase" }}>
                                        Read →
                                    </span>
                                </div>
