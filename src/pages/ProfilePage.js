    ...
    return (
        <div style={{ fontFamily: "'Segoe UI', sans-serif", background: t.bg, minHeight: "100vh", paddingBottom: "40px" }}>
            <div style={{ maxWidth: "650px", margin: "0 auto", padding: "30px 20px" }}>
                ...
                <div style={card}>
                    ...
                    <form onSubmit={handleProfileSave}>
                        ...
                        <input
                            ...
                            style={{ marginBottom: "16px", color: t.textSub }}
                        />
                ...
                {/* Password Section */}
                <div style={card}>
                    <h4 style={{ fontSize: "18px", color: t.text, marginBottom: "16px" }}>
                        🔒 Change Password
                    </h4>

                    {pwMsg && <div style={{ color: "#10b981", fontSize: "13px" }}>{pwMsg}</div>}
                    {pwErr && <div style={{ color: "#ef4444", fontSize: "13px" }}>{pwErr}</div>}
